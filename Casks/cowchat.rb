cask "cowchat" do
  version "0.9.1"
  sha256 "a828df7025c89027f396980729320237600cd2e055652bcb667ae12ca6d6ea5c"

  url "https://github.com/cowboyinc/cowchat/releases/download/v0.9.1/Cowchat-#{version}.dmg"
  name "Cowchat"
